...
UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    private func setupSwitch() {
        ...
        sortingOrderSwitch.label.text = "Sort in Ascending order"
        sortingOrderSwitch.label.font = UIFont.systemFont(ofSize: 17.ifIpad(20))
        sortingOrderSwitch.label.textColor = AFColors.headerText
...
class SortTypeCell<T>: UICollectionViewCell {
    ...
    var sortPosition: UISearchSortPosition<T>? {
        didSet {
            ...
            imageView.image = sortPosition?.image.withRenderingMode(.alwaysTemplate)
        }
    }
    ...
    var isSortPositionSelected: Bool = false {
        willSet {
            ...
            let bgColor = newValue ? UIColor.white.withAlphaComponent(0.2) : UIColor.clear
    ...
    private let label: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.font = UIFont.systemFont(ofSize: 15.ifIpad(18))
    ...
    private func setupViews() {
        ...
        imageView.widthAnchor.constraint(equalToConstant: frame.height * 0.5).isActive = true
        imageView.heightAnchor.constraint(equalToConstant: frame.height * 0.5).isActive = true
        imageView.centerXAnchor.constraint(equalTo: sortButton.centerXAnchor).isActive = true
        imageView.centerYAnchor.constraint(equalTo: sortButton.centerYAnchor).isActive = true
